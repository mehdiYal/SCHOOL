...
class MatiereEleve extends \SchoolBundle\Entity\MatiereEleve implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'matiere', 'eleve', 'evaluation', '' . "\0" . 'SchoolBundle\\Entity\\MatiereEleve' . "\0" . 'note', '' . "\0" . 'SchoolBundle\\Entity\\MatiereEleve' . "\0" . 'date', '' . "\0" . 'SchoolBundle\\Entity\\MatiereEleve' . "\0" . 'remarque'];
        }
